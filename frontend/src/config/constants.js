export const DIVINATION_OPTIONS = [
    ...
    },
    {
        label: '生辰八字',
        key: 'birthday',
        welcome_messages: "为了深入探索并分析你的生辰八字，以揭示命盘中的秘密和机缘，我需要你提供一些基本信息。请告诉我你的出生年月日。",
    },
    {
        label: '测名',
        key: 'name',
        welcome_messages: "欢迎来到测名占卜。在这里，您可以通过您的名字来了解您的命运和特征。请告诉我您的名字。",
    },
    {
        label: '起名',
        key: 'new_name',
        welcome_messages: "欢迎来到命名的艺术之旅。我是一位专业的起名大师，拥有丰富的经验和独特的命名技巧。请告诉我宝宝的相关信息，我能为你提供专业的建议。",
    },
    {
        label: '周公解梦',
        key: 'dream',
        welcome_messages: "梦游者，你已跨越现实的边界，踏入《周公解梦》的神秘之地。每一个梦境都隐藏着深层的信息和寓意。请详细描述你的梦境，让我为你揭示其中的秘密，解读背后的意涵和预兆。",
    },
    {
        label: '梅花易数',
        key: 'plum_flower',
